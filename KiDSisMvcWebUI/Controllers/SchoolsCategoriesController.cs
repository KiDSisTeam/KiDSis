...
{
    public class SchoolsCategoriesController : Controller
    {
        private DataContext db = new DataContext();

        // GET: SchoolsCategories
        public ActionResult Index()
        {
            return View(db.SchoolsCategorys.ToList());
        }

        // GET: SchoolsCategories/Details/5
        ...
        // GET: SchoolsCategories/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: SchoolsCategories/Create
        ...
        // GET: SchoolsCategories/Delete/5
        ...
        // POST: SchoolsCategories/Delete/5
